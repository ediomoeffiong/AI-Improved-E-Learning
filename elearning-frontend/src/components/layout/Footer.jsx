    ...
    <footer className="bg-blue-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Elearning</h3>
            <p className="mb-4 text-blue-100">
              Empowering education through innovative online learning solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/dashboard" className="text-blue-100 hover:text-white">Dashboard</Link></li>
              <li><Link to="/quiz/dashboard" className="text-blue-100 hover:text-white">Quizzes</Link></li>
              <li><Link to="/classroom/dashboard" className="text-blue-100 hover:text-white">Classroom</Link></li>
              <li><Link to="/progress/dashboard" className="text-blue-100 hover:text-white">Progress</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-blue-100 hover:text-white">Community</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-blue-100">
              ...
              <p className="mb-2">Email: info@elearning.com</p>
        ...
        <div className="border-t border-blue-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-100 text-sm">
            &copy; {currentYear} Elearning. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <Link to="/cookies" className="text-blue-100 hover:text-white text-sm">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
